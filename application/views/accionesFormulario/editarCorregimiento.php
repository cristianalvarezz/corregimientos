                        ...
                        <form id="corregimientos" method="post" action="<?= base_url('formulario/actualizar') ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea name="veredas" type="text" class="form-control" id="veredas" style="resize: none;" data-toggle="tooltip" title="Por favor separa los nombres de las veredas con comas." style="resize: none;"><?= set_value('veredas', isset($corregimientos['corregimientos']['veredas']) ? $corregimientos['corregimientos']['veredas']  : '') ?></textarea>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="area" type="number" class="form-control" id="number" min="1" pattern="^[0-9]+" value="<?= set_value('area', isset($corregimientos['corregimientos']['area']) ? $corregimientos['corregimientos']['area']  : '') ?>" maxlength="52">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="nautoridadpolicial" type="text" class="form-control" id="nautoridadpolicial" value="<?= set_value('nautoridadpolicial', isset($corregimientos['corregimientos']['nautoridadpolicial']) ? $corregimientos['corregimientos']['nautoridadpolicial']  : '') ?>" maxlength="150" data-toggle="tooltip" title="Por favor digita nombres que solo contengan caracteres alfabéticos y espacios.">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea name="miembrosjal" type="text" class="form-control" id="miembrosjal" placeholder="Por favor separa los nombres de los miembros con comas." style="resize: none;"><?= set_value('miembrosjal', isset($corregimientos['corregimientos']['miembrosjal']) ? $corregimientos['corregimientos']['miembrosjal']  : '') ?></textarea>
                                    <?= form_error('miembrosjal', '<p class="text-danger">', '</p>') ?>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="jal"> JAL* </label>
                                    <input name="jal" type="text" class="form-control" id="jal" value="<?= set_value('jal', isset($corregimientos['corregimientos']['jal']) ? $corregimientos['corregimientos']['jal']  : '') ?>" data-toggle="tooltip" title="Por favor digita nombres que solo contengan caracteres alfabéticos y espacios." maxlength="250">
